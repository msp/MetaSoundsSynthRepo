...
public class MS1Performer : ModuleRules
{
    private bool bStrictIncludesCheck = true;

    public MS1Performer(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        PublicDependencyModuleNames.AddRange(
            new string[]
            {
                ...
                "CommonUI", "MetasoundEngine", "HarmonixMetasound", "MetasoundGraphCore"
            }
            );
